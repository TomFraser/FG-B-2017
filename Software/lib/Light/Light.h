...
private:
    ...
    #if ROBOT
      //o_bot
      int thresholds[19] = {94, 115, 110, 114, 86, 83, 96, 116, 93, 76, 82, 127, 114, 128, 129, 131, 125, 113, 109};
    #else
      //p2_bot
      int thresholds[19] = {192, 175, 180, 177, 162, 122, 156, 191, 161, 187, 157, 142, 137, 149, 152, 142, 201, -1, 185};
    #endif
