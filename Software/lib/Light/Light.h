...
private:
    ...
    #if ROBOT
      //o_bot
      int thresholds[19] = {80, 87, 67, 73, 51, 83, 101, 124, 101, 64, 80, 100, 117, 100, 100, 93, 102, 83, 63};
    #else
      //p2_bot
      // int thresholds[19] = {180, 159, 166, 170, 140, 121, 151, 196, 161, 188, 157, 128, 137, 123, 131, 126, 206, -1, 185};
      int thresholds[19] = {1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000};
    #endif
