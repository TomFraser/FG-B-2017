...
private:
    ...
    #if ROBOT
      //o_bot
      int thresholds[19] = {162, 168, 157, 159, 91, 133, 197, 230, 175, 120, 123, 226, 231, 232, 231, 233, 246, 198, 159};
    #else
      //p2_bot
      int thresholds[19] = {191, 161, 184, 182, 130, 100, 143, 189, 147, 184, 163, 135, 135, 135, 135, 113, 216, -1, 190};
    #endif
