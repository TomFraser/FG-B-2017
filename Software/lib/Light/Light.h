...
private:
    ...
    #if ROBOT
      //o_bot
      int thresholds[19] = {166, 161, 149, 166, 105, 124, 184, 228, 183, 131, 181, 239, 223, 227, 197, 212, 222, 182, 165};
    #else
      //p2_bot
      int thresholds[19] = {189, 170, 186, 185, 145, 110, 161, 190, 158, 186, 176, 170, 157, 170, 182, 152, 218, -1, 142};
    #endif
