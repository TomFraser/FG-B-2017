...
public:
    ...
    bool move(double angle, double rotation, int speed, bool followingBall); //If this method returns true, then for the next 0.5 seconds, the speed needs to be set to 30
