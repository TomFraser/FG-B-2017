...
void loop(){
    ...
    // directionController.updateGameData(tsopData, rawBallData, ballStrength, lightData, 1, compass);
    directionController.updateGameData(65506, 65506, 0, lightData, 1, compass);
